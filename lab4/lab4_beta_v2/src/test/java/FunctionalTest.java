...
public class FunctionalTest {
    ...
    @Test
    public void sumTest() {
        LinFunction fun = new LinFunction(2, 3, 6, 4);
        SumFunction sum = new SumFunction(2, 8);
    ...
    public void integralDivTest() {
        DivFunction fun = new DivFunction(2, 0, 1, 0, 1, 2);
    ...
    public void integralExpTest() {
        ExpFunction fun = new ExpFunction(2, 3, 2, 0);
        Integral in = new Integral(2, -2, 10);
    ...
    public void Exepstion1() {
        LinFunction fun = new LinFunction(2, 3, 4, 0);
        Integral in = new Integral(2, -2, 5);
